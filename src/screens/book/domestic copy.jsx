...
import contries from "./states.js";
import stateprice from "./statesprice";
import "./index.scss";
import "./button.css";
...
export default function BookDelivery() {
  ...
  const calculatePrice = (weight, delivery_state, pickup_state, zone) => {
    const southwest = ["Ogun", "Oyo", "Osun", "Ekiti", "Ondo"];
    if (delivery.delivery_state === delivery.pickup_state) {
      let srate = stateprice.find((data) => data.weight == delivery.weight);
      var margin = 0.10 * parseInt(srate.Intracity);
      ...
      delivery.delivery_state === "Lagos" &&
      southwest.includes(delivery.pickup_state)
    ) {
      let srate = stateprice.find((data) => data.weight == delivery.weight);
      ...
      delivery.delivery_state !== "Lagos" &&
      delivery.delivery_state !== delivery.pickup_state
    ) {
      let srate = stateprice.find((data) => data.weight == delivery.weight);
      var margin = 0.10 * parseInt(srate.Interstate);
  ...
  const handleTab = (e) => {
    ...
    if (tab == 3) {
      e.preventDefault();
      calculatePrice(delivery.country, delivery.weight, delivery.shipment_type);
      setTab(4);
    }
                ...
                <div className="sumaryWrap">
                  ...
                  <div className="databdd">
                    ...
                    <div className="col text-right">
                      <address style={{ float: "right" }}>
                        <div>
                          {delivery.delivery_state},{"Nigeria"}
                        </div>
                        <div style={{ marginTop: "10px" }}>
                  ...
                  <div className="row">
                    ...
                    >
                      ...
                      <NumberFormat
                        value={total+1}
                        // value={Math.floor(Math.random() * (90000 - 10000) + 10000)}
                        className="foo"
